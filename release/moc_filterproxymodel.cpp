...
namespace {
struct qt_meta_tag_ZN16FilterProxyModelE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16FilterProxyModelE = QtMocHelpers::stringData(
    "FilterProxyModel"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16FilterProxyModelE[] = {
...
Q_CONSTINIT const QMetaObject FilterProxyModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16FilterProxyModelE.offsetsAndSizes,
    qt_meta_data_ZN16FilterProxyModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16FilterProxyModelE_t,
        // Q_OBJECT / Q_GADGET
...
void *FilterProxyModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16FilterProxyModelE.stringdata0))
